...
Mesh::Mesh(const std::string &filepath) { fromObjFile(filepath); }

void Mesh::addTriangle(Triangle &t) { triangles.push_back(t); }

const std::vector<Triangle> &Mesh::getTriangles() { return triangles; };
