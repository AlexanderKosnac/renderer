...
TEST(MultThreeByThreeOnThree, NormalCase) {
    math::mat3x3 m(math::vec3(1.0f, 4.0f, 7.0f), math::vec3(2.0f, 5.0f, 8.0f), math::vec3(3.0f, 6.0f, 9.0f));
...
TEST(MultFourByFourOnFour, NormalCase) {
    math::mat4x4 m(math::vec4(1.0f, 5.0f, 9.0f, 13.0f), math::vec4(2.0f, 6.0f, 10.0f, 14.0f), math::vec4(3.0f, 7.0f, 11.0f, 15.0f), math::vec4(4.0f, 8.0f, 12.0f, 16.0f));
...
TEST(MultThreeByThreeOnThreeByThree, NormalCase) {
    math::mat3x3 m1(math::vec3(1.0f, 4.0f, 7.0f), math::vec3(2.0f, 5.0f, 8.0f), math::vec3(3.0f, 6.0f, 9.0f));
    math::mat3x3 m2(math::vec3(9.0f, 8.0f, 7.0f), math::vec3(6.0f, 5.0f, 4.0f), math::vec3(3.0f, 2.0f, 1.0f));
...
TEST(MultFourByFourOnFourByFour, NormalCase) {
    math::mat4x4 m1(math::vec4(1.0f, 5.0f, 9.0f, 13.0f), math::vec4(2.0f, 6.0f, 10.0f, 14.0f), math::vec4(3.0f, 7.0f, 11.0f, 15.0f), math::vec4(4.0f, 8.0f, 12.0f, 16.0f));
    math::mat4x4 m2(math::vec4(16.0f, 15.0f, 14.0f, 13.0f), math::vec4(12.0f, 11.0f, 10.0f, 9.0f), math::vec4(8.0f, 7.0f, 6.0f, 5.0f), math::vec4(4.0f, 3.0f, 2.0f, 1.0f));
